...
class RusthengeJournalSheet extends JournalSheet {
  getData(options) {
  ...
  static get defaultOptions() {
    ...
    options.classes.push("Rusthenge");
    return options;
  }
...
Hooks.once('init', () => {
  DocumentSheetConfig.registerSheet(JournalEntry, 'Rusthenge', RusthengeJournalSheet, {
    label: "Тема \"Растхендж\"",
    makeDefault: false
  });
});
